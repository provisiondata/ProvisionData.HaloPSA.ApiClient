...
namespace ProvisionData.HaloPSA.ApiClient.Tests;
...
public class HaloPsaApiClientExtensionsTests
{
    ...
    public void AddHaloPsaApiClient_WithConfiguration_ShouldRegisterServices()
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            {
                ["HaloPsaApiClient:AuthUrl"] = "https://test.halo.local/auth/",
                ["HaloPsaApiClient:ApiUrl"] = "https://test.halo.local/api/",
                ["HaloPsaApiClient:ClientId"] = "test-client",
                ["HaloPsaApiClient:ClientSecret"] = "test-secret",
                ["HaloPsaApiClient:PageSize"] = "100"
            }!)
            .Build();
    ...
    public void AddHaloPsaApiClient_WithCustomConfigurationSection_ShouldRegisterServices()
    {
        ...
        // Act
        var httpClientBuilder = services.AddHaloPsaApiClient(configuration, "CustomSection");
