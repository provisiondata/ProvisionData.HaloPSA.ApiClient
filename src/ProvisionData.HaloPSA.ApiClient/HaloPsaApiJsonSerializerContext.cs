...
/// When you run the model generator, it will create <c>HaloPsaApiJsonSerializerContext.g.cs</c>
...
public partial class HaloPsaApiJsonSerializerContext : JsonSerializerContext
{
}
