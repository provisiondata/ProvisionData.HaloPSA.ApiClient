...
public partial class QuotationTotals
{
    [JsonPropertyName("taxTotalEstimate")]
    public Double TaxTotalEstimate { get; set; }

    [JsonPropertyName("taxTotalEstimateConverted")]
    public Double TaxTotalEstimateConverted { get; set; }
